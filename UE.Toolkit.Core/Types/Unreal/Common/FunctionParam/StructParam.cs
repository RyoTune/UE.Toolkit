...
public class StructParam(nint ptr, int size, IUnrealMemoryInternal? memory = null) : IFunctionParam, IDisposable
{
    public string PropertyType => "StructProperty";
